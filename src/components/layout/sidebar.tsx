...
const adminNavItems: NavItem[] = [
  ...
  { label: 'طلبات الخدمات الخاصة', href: '/admin/special-requests', icon: MessageSquare, permission: 'manage_orders', group: 'operations' },
...
const nurseNavItems: NavItem[] = [
  ...
  { label: 'مهمات خاصة', href: '/nurse/special-requests', icon: MessageSquare, group: 'work' },
...
const beneficiaryNavItems: NavItem[] = [
  ...
  { label: 'طلب خدمة خاصة', href: '/beneficiary/special-requests', icon: MessageSquare, group: 'services' },

...
const YEMENI_WALLETS: Record<string, { nameAr: string; color: string }> = {
  ...
  saba_cash: { nameAr: 'سبأ كاش', color: 'from-teal-500 to-teal-600' },
  mobile_money: { nameAr: 'موبايل موني', color: 'from-indigo-500 to-indigo-600' },
  mahfathati: { nameAr: 'محفظتي', color: 'from-sky-500 to-sky-600' },
  yemen_wallet: { nameAr: 'يمن والت', color: 'from-stone-500 to-stone-600' },
  al_mutakamila: { nameAr: 'المتكاملة', color: 'from-violet-500 to-violet-600' },
...
const YEMENI_EXCHANGES: Record<string, { nameAr: string; color: string }> = {
  ...
  al_saifi: { nameAr: 'صرافة الصيفي', color: 'from-teal-500 to-teal-600' },
  al_aidrous: { nameAr: 'صرافة العيدروس', color: 'from-orange-500 to-orange-600' },
  dadiya: { nameAr: 'صرافة دادية', color: 'from-cyan-500 to-cyan-600' },
  al_akwa: { nameAr: 'صرافة الأكوع', color: 'from-rose-500 to-rose-600' },
  al_nasser: { nameAr: 'صرافة الناصر', color: 'from-indigo-500 to-indigo-600' },
  al_mumayaz: { nameAr: 'صرافة المميز', color: 'from-lime-500 to-lime-600' },
  al_muraisi: { nameAr: 'صرافة المريسي', color: 'from-sky-500 to-sky-600' },
  al_shabouti: { nameAr: 'صرافة الشبوطي', color: 'from-emerald-500 to-emerald-600' },
};
